const Hero:React.FC = () => {
    return (
      <div className="bg-gradient-to-r from-indigo-900 to-purple-900 font-site">
        <div className="relative overflow-hidden">
          <div className="max-w-screen-xl mx-auto py-16 px-4 sm:px-6 lg:py-32 lg:px-8">
            <div className="relative z-10 text-center lg:text-left">
              <h1 className="text-2xl tracking-tight leading-10 font-extrabold text-white sm:text-5xl sm:leading-none md:text-6xl lg:text-4xl">
                Welcome to
                <br className="xl:hidden" />
                <span className="text-indigo-400"> Premium Delights</span>
              </h1>
              <p className="max-w-md text-lg text-gray-300 sm:text-xl mt-4 md:mt-6 md:max-w-3xl">
          ...
          <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://res.cloudinary.com/pnkjkhani/image/upload/c_scale,h_1132,q_100/v1725180179/emhq95dghxz7kfl0xlud.png" alt="Delicious Food" />
          </div>
        </div>
      </div>
    )
