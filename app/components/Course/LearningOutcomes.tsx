...
const LearningOutcomes: React.FC = () => {
  return (
    <section className="mx-auto flex max-w-xl flex-col rounded-3xl border-blue-300 px-4 py-10 text-gray-700 sm:border-8 sm:px-10 lg:max-w-screen-lg lg:flex-row font-site lg:my-6">
  <div className="mr-2">
    <h2 className="mb-4 text-4xl font-medium">A Better <span className="text-blue-600">Learning Experience</span></h2>
  ...
  <div className="h-96">
    <img className="h-full w-auto object-cover " src="https://images.unsplash.com/photo-1534643960519-11ad79bc19df?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
  </div>
</section>
