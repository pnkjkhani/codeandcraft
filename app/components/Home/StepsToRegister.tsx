const StepsToRegister: React.FC = () => {
    return (
      <section className="bg-gray-50 py-12 sm:py-16 lg:py-10 xl:py-14 mx-auto">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
              <p className="text-sm font-bold uppercase tracking-widest text-blue-500">How It Works</p>
              <h2 className="mt-6 text-3xl font-bold tracking-tight text-blue-900 sm:text-4xl lg:text-5xl">Register to any course
                  in
                  4 easy steps
              </h2>
              <p className="mx-auto mt-4 max-w-2xl text-lg font-normal text-blue-500 lg:text-xl lg:leading-8">
                  Let's create new experiences and shape our future together!
              </p>
          </div>
          <ul className="mx-auto mt-12 grid max-w-md grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:max-w-5xl lg:grid-cols-4">
              <li className="flex-start group relative flex lg:flex-col">
                  ...
                  <div
                      className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-gray-300 bg-gray-50 transition-all duration-200 group-hover:border-purple-site group-hover:bg-purple-site">
                  ...
                  <div className="ml-6 lg:ml-0 lg:mt-10">
                      <h3
                          className="text-xl font-bold text-blue-900 before:mb-2 before:block before:font-mono before:text-sm before:text-blue-500">
                          Add your databases
                      </h3>
                      <h4 className="mt-2 text-base text-blue-700">Use your own Notion databases or duplicate ours.</h4>
                  </div>
              </li>
              <li className="flex-start group relative flex lg:flex-col">
                  <span
                  ...
                  <div className="ml-6 lg:ml-0 lg:mt-10">
                      ...
                      <h4 className="mt-2 text-base text-blue-700">Map your Notion fields with Feather fields.</h4>
                  </div>
              </li>
              <li className="flex-start group relative flex lg:flex-col">
                  <span
                  ...
                  <div className="ml-6 lg:ml-0 lg:mt-10">
                      ...
                      <h4 className="mt-2 text-base text-blue-700">Choose a domain or a subdomain for your blog.</h4>
                  </div>
              </li>
              <li className="flex-start group relative flex lg:flex-col">
                  <div
                  ...
                  <div className="ml-6 lg:ml-0 lg:mt-10">
                      ...
                      <h4 className="mt-2 text-base text-blue-700">That's it. You will get back a professional blog.</h4>
                  </div>
              </li>
          </ul>
      </div>
